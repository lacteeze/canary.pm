...
export const Icon = ({ name, size = 16 }) => {
  ...
  const paths = {
    ...
    moon: <path d="M21 12.79A9 9 0 1111.21 3 7 7 0 1021 12.79z"/>,
...
export function PhotoPlaceholder({ seed = 0, label }) {
...
export function Sparkline({ data, color = "#1a1814", fill = false, height = 32 }) {
...
export function BarChart({ data, labels, color = "#1a1814", height = 200 }) {
  const w = 700, h = height, pad = { l: 36, r: 12, t: 16, b: 24 };
...
export function Donut({ segments, total, size = 140 }) {
  const r = size / 2 - 10;
