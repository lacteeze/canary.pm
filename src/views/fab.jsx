...
function CreateFormModal({ type, onClose }) {
  ...
  const handleSubmit = () => { console.log(`Creating ${type}:`, data); onClose(); };

  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 100, background: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'flex-end' }}>
      <div style={{ width: '100%', maxWidth: 500, background: 'var(--bg-elev)', borderRadius: '16px 16px 0 0', padding: '24px', maxHeight: '90vh', overflowY: 'auto' }}>
