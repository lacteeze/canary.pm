...
import { Icon, PhotoPlaceholder, LineChart, BarChart, Donut } from '../ui.jsx';
import { KpiCard, Topbar } from '../shared.jsx';
import {
  CLIENTS, TENANTS, VENDORS, PROPERTIES, PORTFOLIOS, LEASES, PAYMENTS, PROJECTS, ACTIVITY,
  getProperty, getTenant, getClient, getVendor, fmt, fmtCompact, initials
} from '../data.js';
            ...
            <div className="panel-body">
              <LineChart height={220} labels={MONTHS}
                series={[
                  ...
                  { color: '#F5C518', data: REV.map(v => v * 0.3) },
                ]}/>
    ...
    <>
      ...
      <div className="app-content">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 14 }}>
          {PORTFOLIOS.map(pf => {
            const props = pf.propertyIds.map(getProperty).filter(Boolean);
