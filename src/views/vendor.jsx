...
import { VENDORS, PROJECTS, getProperty, fmt } from '../data.js';

export function VendorViews({ section }) {
    ...
    return (<>
      ...
      <div className="app-content">
        <div className="kpi-row">
          <div className="kpi-card"><div className="label">Open work orders</div><div className="value">6</div></div>
          <div className="kpi-card"><div className="label">This week's schedule</div><div className="value">4 jobs</div></div>
          <div className="kpi-card"><div className="label">Outstanding invoices</div><div className="value">$4,240</div></div>
          <div className="kpi-card"><div className="label">Rating</div><div className="value">★ {vendor.rating}</div></div>
        </div>
