...
import { TENANTS, LEASES, getProperty, fmt } from '../data.js';

export function TenantViews({ section }) {
          ...
          <div className="panel">
            ...
            <div className="panel-body">
              <div style={{ fontSize: 13 }}>
                {[
                  ['Term', `${lease.start} → ${lease.end}`],
                  ['Rent', `${fmt(lease.rent)}/mo`],
                  ['Deposit', fmt(lease.rent)],
                ].map(([label, val], i) => (
                  <div key={i} style={{ display:'flex', justifyContent:'space-between', padding: '6px 0', borderBottom: '1px solid var(--line-2)' }}>
