              ...
              <div style={{ marginTop: 16, fontSize: 13 }}>
                {[
                  ...
                  <div key={i} style={{ display:'flex', justifyContent:'space-between', padding: '5px 0', borderBottom: '1px solid var(--line-2)' }}>
                    <span className={r.muted ? 'muted' : ''} style={{ color: r.muted ? 'var(--ink-3)' : 'var(--ink-2)' }}>{r.l}</span>
    ...
    <div className="app-content">
      <div className="panel">
        <table className="data-table">
          ...
          <tbody>
            {['Mar 2026','Feb 2026','Jan 2026','Dec 2025','Nov 2025','Oct 2025'].map((m, i) => (
              <tr key={m}>
...
Object.assign(window, { OwnerViews });
